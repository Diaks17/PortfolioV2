...
import { gsap as gsap$2 } from 'file:///Users/diaks/PortfolioV2/node_modules/gsap/dist/gsap.js';
import { mergeProps, withCtx, createTextVNode, toDisplayString, useSSRContext } from 'file:///Users/diaks/PortfolioV2/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrInterpolate } from 'file:///Users/diaks/PortfolioV2/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  mounted() {
    ...
    this.projects.forEach((project, index2) => {
      gsap$2.from(`.projets-link:nth-child(${index2 + 1})`, {
        scrollTrigger: {
  ...
  data() {
    return {
      projects: [
        ...
        { name: "J'AIME \xC7A", route: "/projects/web/jaimeca" }
...
//# sourceMappingURL=index-qlyiSdvE.mjs.map
