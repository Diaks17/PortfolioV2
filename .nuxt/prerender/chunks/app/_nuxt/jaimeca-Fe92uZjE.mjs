...
const _imports_0 = "" + publicAssetsURL("img/jaimeca3.jpg");
const _sfc_main = {
  components: {
...
export { jaimeca as default };
//# sourceMappingURL=jaimeca-Fe92uZjE.mjs.map
